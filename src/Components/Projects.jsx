...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="dark:bg-[#1F1F25] bg-white text-[#1F1F25] dark:text-[#ECEBF0] pt-32 pb-32 md:pt-44"
    >
      <div className=" container mx-auto text-center px-3 md:px-0 w-full">
        <h2 className=" dark:text-[#FFFFFF] text-[#1F1F25] text-4xl md:text-7xl md:font-black font-extrabold">
          My Latest Project
        </h2>
        <p className=" dark:text-[#9A9DA8] text-[#717173] mt-7 text-xl font-light">
          These are a few of my previous projects.
        </p>
        ...
        >
          <TabList className=" flex  flex-wrap md:justify-center">
            <Tab
              className={
                "pr-10 py-3 cursor-pointer text-xl outline-none border-none font-semibold overflow-hidden after:content-[''] after:block after:h-1 after:w-6 after:mt-2 after:border-t-[3px] after:border-t-gray-400 after:origin-left after:transition-all after:duration-500" +
                (tabIndex === 0
                  ? " text-[#04d2f7] after:w-full after:border-t-[#04d2f7]"
                  : "")
              }
            >
              Web App
          ...
          <TabPanel>
            <div className="  mt-20 flex flex-wrap justify-around md:gap-x-7 gap-y-40 md:gap-y-44 mb-12">
              <a className=" w-full md:w-fit "
                href="https://haroon-s.github.io/quizzical-react-app/"
                target="_blank"
              >
                <div className="group h-[385px] w-full md:w-[600px] md:h-[350px] bg-[url('/src/assets/Quiz1.png')] bg-no-repeat bg-cover bg-[position:center] transition-all duration-300 md:hover:scale-105 text-center shadow-2xl rounded-2xl">
                  <div className=" w-full h-full transition-all duration-300 md:hover:bg-gradient-to-b hover:from-[#04d3f7a9] hover:to-[#6b119c59] flex items-end justify-center rounded-2xl"></div>
                  <h2 className=" text-3xl dark:text-[#ECEBF0] text-[#1F1F25] mt-7  p-3 rounded-full font-extrabold ">
                    Quizzical App
                  </h2>
                </div>
                <button type="button" class="text-xl text-[#ECEBF0] mt-24  p-3 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg px-5 py-2.5 text-center mr-2 mb-2 inline-flex gap-2 items-center">Visit <RiShareForwardBoxLine /> </button>
              </a>
              <a className=" w-full md:w-fit "
                href="https://haroon-s.github.io/Tensize-Game/"
                target="_blank"
              >
                <div className="group h-[385px] w-full md:w-[600px] md:h-[350px] bg-[url('/src/assets/Tensize.png')] bg-no-repeat bg-cover bg-[position:center] transition-all duration-300 md:hover:scale-105 text-center shadow-2xl rounded-2xl">
                  <div className=" w-full h-full transition-all duration-300 md:hover:bg-gradient-to-b hover:from-[#4de4ffa9] hover:to-[#6b119c59] flex items-end justify-center rounded-2xl"></div>
                  <h2 className=" text-3xl dark:text-[#ECEBF0] text-[#1F1F25] mt-7  p-3 rounded-full font-extrabold ">
                    Tensize Game 
                  </h2>
                </div>
              ...
              <a className=" w-full md:w-fit "
                href="https://www.puentehq.com/"
                target="_blank"
              >
                <div className="group h-[385px] w-full md:w-[600px] md:h-[350px] bg-[url('/src/assets/Puente.png')] bg-no-repeat bg-cover bg-[position:left] transition-all duration-300 md:hover:scale-105 text-center shadow-2xl rounded-2xl">
                  <div className=" w-full h-full transition-all duration-300 md:hover:bg-gradient-to-b hover:from-[#4de4ffa9] hover:to-[#6b119c59] flex items-end justify-center rounded-2xl"></div>
                  <h2 className=" text-3xl dark:text-[#ECEBF0] text-[#1F1F25] mt-7  p-3 rounded-full font-extrabold ">
                    Puente HQ
                  </h2>
              ...
              <a className=" w-full md:w-fit "
                ...
                target="_blank"
              >
                <div className="group h-[385px] w-full md:w-[600px] md:h-[350px] bg-[url('/src/assets/major1.png')] bg-no-repeat bg-cover bg-[position:center] transition-all duration-300 md:hover:scale-105 text-center shadow-2xl rounded-2xl">
                  <div className=" w-full h-full transition-all duration-300 md:hover:bg-gradient-to-b hover:from-[#4de4ffa9] hover:to-[#6b119c59] flex items-end justify-center rounded-2xl"></div>
                  <h2 className=" text-3xl dark:text-[#ECEBF0] text-[#1F1F25] mt-7  p-3 rounded-full font-extrabold ">
                    MajorGen Web
                  </h2>
              ...
              <a className=" w-full md:w-fit "
                href="https://astrosami.com/"
                target="_blank"
              >
                <div className="group h-[385px] w-full md:w-[600px] md:h-[350px] bg-[url('/src/assets/Astro.png')] bg-no-repeat bg-cover bg-[position:left] transition-all duration-300 md:hover:scale-105 text-center shadow-2xl rounded-2xl">
                  <div className=" w-full h-full transition-all duration-300 md:hover:bg-gradient-to-b hover:from-[#4de4ffa9] hover:to-[#6b119c59] flex items-end justify-center rounded-2xl"></div>
                  <h2 className=" text-3xl dark:text-[#ECEBF0] text-[#1F1F25] mt-7  p-3 rounded-full font-extrabold ">
                    AstroSami Web
                  </h2>
